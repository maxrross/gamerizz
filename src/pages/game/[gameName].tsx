  ...
  return (
    ...
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-10">
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Game: <span className="text-blue-600">{displayName}</span></h1>
          ...
          <div className="mt-7 grid gap-3 w-full sm:inline-flex">
            ...
            <button onClick={() => setUpvoteCount(upvoteCount + 1)}><ArrowUpCircle /></button>
            <span className="text-gray-800 dark:text-gray-200">{upvoteCount}</span>
            <a className=""><ArrowDownCircle /></a>
            </div>
          </div>
          ...
          <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            ...
            <div className="py-5">
              ...
              <div className="mt-3">
                <img src="../../steam.svg" alt="steam" className="h-2/3 w-2/3" />
              </div>
            </div>
          </div>
        </div>
